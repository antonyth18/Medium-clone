import type { SignupInput } from "@antony_th18/medium-common";
import axios from "axios";
import { useState, type ChangeEvent } from "react";
import { Link, useNavigate } from "react-router-dom"
import { BACKEND_URL } from "../config";

//ideally MAKE SEPARATE SIGNIN AND SIGNUP COMPONENTS
        ...
        <div className="flex justify-center">
            <div>
                ...
                <div className="text-slate-500 text-center">
                    ...
                    <Link className="underline" to = {type === "signup"? "/signin": "/signup"}> {type === "signup"? "Login" : "Sign Up"} </Link> 
                    
                </div>

                {type ==="signup" ? <InputBox label="First name" placeholder="John" onChange={(e) => {
                    setPostInputs({
                        ...postInputs,
                ...
                {type ==="signup" ? <InputBox label="Last name" placeholder="Doe" onChange={(e) => {
                    setPostInputs({
                        ...postInputs,
